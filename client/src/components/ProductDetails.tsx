    ...
    return (
        <div className="product-detail-container p-10 mt-20">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                ...
                <div className="product-images w-full sm:w-full lg:w-full">
                    <img
                    ...
                    <div className="image-gallery flex space-x-4">
                        <img src={product.image_url} alt={product.name} className="w-20 h-20 object-cover rounded-lg shadow-md" />
                        <img src={product.image_url} alt={product.name} className="w-20 h-20 object-cover rounded-lg shadow-md" />
                        <img src={product.image_url} alt={product.name} className="w-20 h-20 object-cover rounded-lg shadow-md" />
                    </div>

                    {/* More Details Section (Below Product Image and Information) */}{/* More Details Section (Below Product Image and Information) */}
                    <div className="more-details mt-10 w-full sm:w-full lg:w-full justify-items-start ">
                ...
                <div className="product-info">
                    ...
                    {/* Size Selection */}
                    <div className="size-selection mt-6">
                        <label htmlFor="ring-size" className="block text-lg font-medium text-gray-700">Ring Size</label>
                        <select
                            id="ring-size"
                            value={selectedSize}
                            onChange={(e) => setSelectedSize(e.target.value)}
                            className="mt-2 p-3 border rounded-md w-full focus:outline-none focus:ring-2 focus:ring-gray-500"
                        >
                    ...
                    {/* Finishing Selection */}
                    <div className="finishing-selection mt-6">
                        <label htmlFor="finishing" className="block text-lg font-medium text-gray-700">Finishing</label>
                        <select
                            id="finishing"
